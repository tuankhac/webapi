...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/assets/files/gtag/**").addResourceLocations("/assets/files/gtag/")
				.setCachePeriod(31556926);
		registry.addResourceHandler("/assets/files/pages/**").addResourceLocations("/assets/files/pages/")
				.setCachePeriod(31556926);
		// resource test
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		// registry.addInterceptor(localeInterceptor).addPathPatterns("/vi/**",
		// "/en/**", "/fr/**");
		...
		registry.addInterceptor(adminInterceptor())
				...
				.excludePathPatterns(ConstantParams.SLASH + ConstantParams.ADMIN_PATH + "logout");
