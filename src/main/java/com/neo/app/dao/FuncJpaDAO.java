...
// import com.neo.app.utils.SHA512;
//
// @Repository
...
// Query query = session.createQuery("FROM Admin WHERE password = :password");
...
// Session session = sessionFactory.getCurrentSession();
// Query query = session.createQuery("FROM Admin WHERE fullName LIKE
// :fullName");
...
// password = SHA512.encrypt(password);
// Session session = sessionFactory.getCurrentSession();
// Query query = session.createQuery("FROM Admin WHERE username = :username and
// password = :password");
// query.setString("username", username);
// query.setString("password", password);
