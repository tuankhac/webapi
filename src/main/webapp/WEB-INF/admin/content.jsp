		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h5>
							<s:message code="label.dashboard"></s:message>${menus}
						</h5>
						<span><s:message code="label.message"></s:message> </span>${menus}
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item"><a href="index.html#!"><s:message
									...
									<div class="scroll-widget">
										<div class="latest-update-box">
											<div class="row p-t-20 p-b-30">
												...
												<div class="col p-l-5">
													<a href="index.html#!"><h6>Your Manager Posted.</h6></a>
											...
											<div class="row p-b-30">
												...
												<div class="col p-l-5">
													<a href="index.html#!"><h6>You have 3 pending
															Task.</h6></a>
											...
											<div class="row p-b-30">
												...
												<div class="col p-l-5">
													<a href="index.html#!"><h6>New Order Received.</h6></a>
													<p class="text-muted m-b-0">Hemilton</p>
												</div>
											</div>
											<div class="row p-b-30">
									...
									<div class="scroll-widget">
										<div class="latest-update-box">
											<div class="row p-t-20 p-b-30">
												...
												<div class="col p-l-5">
													<a href="index.html#!"><h6>Devlopment & Update</h6></a>
													<p class="text-muted m-b-0">
														Lorem ipsum dolor sit amet, <a href="index.html#!"
															class="text-c-blue"> More</a>
													</p>
												</div>
											</div>
											<div class="row p-b-30">
												...
												<div class="col p-l-5">
													<a href="index.html#!"><h6>Showcases</h6></a>
													<p class="text-muted m-b-0">
														Lorem dolor sit amet, <a href="index.html#!"
															class="text-c-blue"> More</a>
													</p>
												</div>
											</div>
											<div class="row p-b-30">
												...
												<div class="col p-l-5">
													<a href="index.html#!"><h6>Miscellaneous</h6></a>
													<p class="text-muted m-b-0">
														Lorem ipsum dolor sit ipsum amet, <a href="index.html#!"
															class="text-c-green"> More</a>
													</p>
												</div>
											</div>
											<div class="row p-b-30">
										...
										<table class="table table-hover m-b-0">
											...
											<tbody>
												<tr>
													...
													<td>#PHD001</td>
													<td><a
														href="javascript:if(confirm('https://colorlib.com/cdn-cgi/l/email-protection\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='https://colorlib.com/cdn-cgi/l/email-protection'"
														class="__cf_email__"
														data-cfemail="18797a7b587f75797174367b7775">[email&#160;protected]</a></td>
													<td><label class="label label-danger">Out
															Stock</label></td>
													<td><a href="index.html#!"><i
															class="fa fa-star f-12 text-c-yellow"></i></a> <a
														href="index.html#!"><i
															class="fa fa-star f-12 text-c-yellow"></i></a> <a
														href="index.html#!"><i
															class="fa fa-star f-12 text-c-yellow"></i></a> <a
														href="index.html#!"><i
															class="fa fa-star f-12 text-default"></i></a> <a
														href="index.html#!"><i
												...
												<tr>
													...
													<td><a
														href="javascript:if(confirm('https://colorlib.com/cdn-cgi/l/email-protection\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='https://colorlib.com/cdn-cgi/l/email-protection'"
														class="__cf_email__"
														data-cfemail="bcdfd8dffcdbd1ddd5d092dfd3d1">[email&#160;protected]</a></td>
												...
												<tr>
													...
													<td><a
														href="javascript:if(confirm('https://colorlib.com/cdn-cgi/l/email-protection\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='https://colorlib.com/cdn-cgi/l/email-protection'"
														class="__cf_email__"
														data-cfemail="d0a0a1a290b7bdb1b9bcfeb3bfbd">[email&#160;protected]</a></td>
													<td><label class="label label-danger">Out
															Stock</label></td>
													<td><a href="index.html#!"><i
															class="fa fa-star f-12 text-c-yellow"></i></a> <a
												...
												<tr>
													...
													<td><a
														href="javascript:if(confirm('https://colorlib.com/cdn-cgi/l/email-protection\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='https://colorlib.com/cdn-cgi/l/email-protection'"
														class="__cf_email__"
														data-cfemail="5133322211363c30383d7f323e3c">[email&#160;protected]</a></td>
													<td><label class="label label-success">In
															Stock</label></td>
													<td><a href="index.html#!"><i
															class="fa fa-star f-12 text-c-yellow"></i></a> <a
												...
												<tr>
													...
													<td><a
														href="javascript:if(confirm('https://colorlib.com/cdn-cgi/l/email-protection\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='https://colorlib.com/cdn-cgi/l/email-protection'"
														class="__cf_email__"
														data-cfemail="4c2f282f0c2b212d2520622f2321">[email&#160;protected]</a></td>
													<td><label class="label label-success">In
															Stock</label></td>
													<td><a href="index.html#!"><i
															class="fa fa-star f-12 text-c-yellow"></i></a> <a
												...
												<tr>
													...
													<td><a
														href="javascript:if(confirm('https://colorlib.com/cdn-cgi/l/email-protection\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='https://colorlib.com/cdn-cgi/l/email-protection'"
														class="__cf_email__"
														data-cfemail="7b0b0a093b1c161a121755181416">[email&#160;protected]</a></td>
													<td><label class="label label-danger">Out
															Stock</label></td>
													<td><a href="index.html#!"><i
															class="fa fa-star f-12 text-c-yellow"></i></a> <a
